...
import{PhysicianNavbarComponent} from '../../hospital-users/physician-dashboard/physician-navbar/physician-navbar.component'
...
export class PatientRegComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,private route:Router,private httpObj: HttpClient,
              private service:PatientRegService, private notify:ToastrService) { }
  ...
  //     this.notify.success("Patient Registered Successfully", "Success");
  //     //return true;
  //   }
  // }
